class WebGlConfig
{
    constructor (extension, linearExtension, glType, arrayType)
    {
...
class RenderWebGlProgram extends BaseWebGlProgram
{
    constructor (id, locations)
    {
        ...
        this.topLeft = new Float32Array(2);
        this.bottomRight = new Float32Array(2);
        this.containerRatio = new Float32Array(2);
        this.scroll = 0;
    }
}

function createProgram(ctor, gl, vertexSource, fragmentSource)
{
...
class Ripples
{
    constructor (canvas, resolution = 256)
    {
        this.interactive = true;
        this.transparentPixels = createImageData(32, 32);
        this.textures = [];
        this.framebuffers = [];

        this.dropCircleProgram = null;
        this.dropBoxProgram = null;
    ...
    dropQuad = (x, y, width, height, strength) =>
    {
